...
// #define natoms 3072    // the total number of nucleus
// #define noxygen 1024    // the number of oxygen
// #define nhydrogen 2048 // the number of hydrogen
// #define R_c 10 / 0.529177  // R_cut
...
int main(){
    ...
    // get G2 features
    get_G2features(features_G2OO, parameters2_OO, rij, 0, 0, "features_G2OO.txt");
    get_G2features(features_G2OH, parameters2_OH, rij, 0, 1, "features_G2OH.txt");
    get_G2features(features_G2HO, parameters2_HO, rij, 1, 0, "features_G2HO.txt");
    get_G2features(features_G2HH, parameters2_HH, rij, 1, 1, "features_G2HH.txt");
    // get G4 features
    get_G4features(features_G4OOO, parameters4_OOO, rij, 0, 0, 0, "features_G4OOO.txt");
    get_G4features(features_G4OOH, parameters4_OOH, rij, 0, 0, 1, "features_G4OOH.txt");
    get_G4features(features_G4OHH, parameters4_OHH, rij, 0, 1, 1, "features_G4OHH.txt");
    get_G4features(features_G4HHO, parameters4_HHO, rij, 1, 1, 0, "features_G4HHO.txt");
    get_G4features(features_G4HOO, parameters4_HOO, rij, 1, 0, 0, "features_G4HOO.txt");
    // get dG2 features
    get_dG2features(features_dG2OO, parameters2_OO, rij, vecrij, 0, 0, "features_dG2OO.txt");
    get_dG2features(features_dG2OH, parameters2_OH, rij, vecrij, 0, 1, "features_dG2OH.txt");
    get_dG2features(features_dG2HO, parameters2_HO, rij, vecrij, 1, 0, "features_dG2HO.txt");
    get_dG2features(features_dG2HH, parameters2_HH, rij, vecrij, 1, 1, "features_dG2HH.txt");

    // get dG4 features
    get_dG4features(features_dG4OOO, parameters4_OOO, rij, vecrij, 0, 0, 0, "features_dG4OOO.txt");
    get_dG4features(features_dG4OOH, parameters4_OOH, rij, vecrij, 0, 0, 1, "features_dG4OOH.txt");
    get_dG4features(features_dG4OHH, parameters4_OHH, rij, vecrij, 0, 1, 1, "features_dG4OHH.txt");
    get_dG4features(features_dG4HHO, parameters4_HHO, rij, vecrij, 1, 1, 0, "features_dG4HHO.txt");
    get_dG4features(features_dG4HOO, parameters4_HOO, rij, vecrij, 1, 0, 0, "features_dG4HOO.txt");
    return 0;
